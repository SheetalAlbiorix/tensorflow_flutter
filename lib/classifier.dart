...
abstract class Classifier {
  ...
  final String _labelsFileName = 'assets/model.txt';
  ...
  List<Category> predict(Image image) {
    ...
    return [
      Category(pred[0].key, pred[0].value),
      Category(pred[1].key, pred[1].value),
      Category(pred[2].key, pred[2].value),
    ];
  }
...
List<MapEntry<String, double>> getTopProbability(
